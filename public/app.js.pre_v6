...
const OCR_CACHE_PREFIX = 'azal-notam-ocr-v5:';
...
function analyzeRoute(blocks, route) {
  ...
  const routeKeywords = /(ATS RTE|AIRWAY|AIRWAYS|WAYPOINT|WAYPOINTS|ENTRY\/EXIT|SEGMENT|SEGMENTS|UNAVBL|NOT AVBL|UNSERVICEABLE|U\/S|CLSD|CLOSED|RESTRICTED|PROHIBITED|AVBL|NOT AVAILABLE|OUT OF SERVICE|LIMITED|ADVISED TO USE|VOR|VOR\/DME|DME|NDB|FIX|RNAV|SID|STAR|AUP|TSA|TRA|ACT|DUE TO OPS|BTN)/;
